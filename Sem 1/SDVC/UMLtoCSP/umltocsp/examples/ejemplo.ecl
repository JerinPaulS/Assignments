...
nAttribute2_2_1NoStudentReviewers( Instances, Vars, Result):-
	...
	ocl_attributeCall(Instances, "Researcher", "isStudent", Object, Result).
...
nAttribute2_1PaperLength( Instances, Vars, Result):-
	...
	ocl_attributeCall(Instances, "Paper", "wordCount", Object, Result).
...
nAttribute1_2LimitsOnStudentPapers( Instances, Vars, Result):-
	...
	ocl_attributeCall(Instances, "Paper", "studentPaper", Object, Result).
